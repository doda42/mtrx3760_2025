...
//
// It does not encapsulate everything or make appropriate use of stl containers.
//
// It is however a strong example of polymorphism and composition, so there is
// exactly ONE place where a circuit keeps track of its components, not 
// individual lists of gates, or even individual lists of half adders or 
// other subcircuits.
//
// Copyright (c) Donald Dansereau, 2025
