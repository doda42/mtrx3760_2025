...
//-----------------------------------------------------------------------------
class FireDetectorNode: public ISensorCallable, public CNode
{
  public:
  private:
    History MyHistory;
...
//-----------------------------------------------------------------------------
class FireDetectorPN: public FireDetectorNode
{
  public:
...
//-----------------------------------------------------------------------------
class FireDetectorCam: public FireDetectorNode
{
  public:
    void Callback( int Value )
    {
...
int main()
{
  ...
  FireDetectorNode* pDetector = NULL;
  
  switch( Choice )
  {
    case 0:
      pDetector = new FireDetectorCam;
    break;
    case 1:
      pDetector = new FireDetectorPN;    
    break;
    default:
  ...
  if( pDetector != NULL )
  {
    CHardwareEmulator MyEmulator( *pDetector );
